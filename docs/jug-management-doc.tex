...
\item register yourself as a member of the CEJUG Community at \\ http://cejug.org/jug/registration.xhtml. You will have access to the repository only if you are a CEJUG member.
\end{enumerate}
